...
Reviewers can download the Android app at **[escape.mittonvillage.com/android](https://escape.mittonvillage.com/android/)**
(or just play in the browser). Full build path in [`docs/ANDROID.md`](docs/ANDROID.md);
...
Release signing reads a gitignored `client/android/keystore.properties` (keystore kept
outside the repo); see [`docs/ANDROID.md`](docs/ANDROID.md). `./scripts/deploy-server.sh`
