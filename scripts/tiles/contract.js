...
const TILE_LIST = [
  ...
  { name: 'WATER_SHALLOW', index: 17, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterShallow' },
  ...
  { name: 'WATER_EDGE_N', index: 37, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_EDGE_E', index: 38, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_EDGE_S', index: 39, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_EDGE_W', index: 40, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_CORNER_NE', index: 41, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_CORNER_NW', index: 42, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_CORNER_SE', index: 43, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_CORNER_SW', index: 44, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_ICORNER_NE', index: 45, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_ICORNER_NW', index: 46, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_ICORNER_SE', index: 47, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  { name: 'WATER_ICORNER_SW', index: 48, layer: 'ground', solid: true, ysort: 'none', build: 'buildWaterEdge' },
  ...
  { name: 'POND_EDGE', index: 123, layer: 'ground', solid: true, ysort: 'none', build: 'buildPondEdge' },
